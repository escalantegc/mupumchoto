...
class ci_tipo_documento extends mupum_ci
{
	protected $s__where;
	...
	function evt__procesar()
	{
		try{
			...
			if(strstr($mensaje_log,'idx_tipo_documento'))
			{
	...
	function conf__frm(ei_frm_tipo_documento $form)
	{
	...
	function conf__cuadro(mupum_ei_cuadro $cuadro)
	{
		...
		if(isset($this->s__datos_filtro))
		{
			...
			$datos = dao::get_listado_tipo_documento($this->s__where);
		}else{
			$datos = dao::get_listado_tipo_documento();
		}
